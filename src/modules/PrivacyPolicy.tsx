...
ELYSIA (<a href="http://elysia.kr">http://elysia.kr</a>) processes the personal information with the consent of the person to perform the duties based on the Article 15 (Collection and Use of Personal Information) of [PERSONAL INFORMATION PROTECTION ACT] for the following purposes. Processed personal information shall not be used for other purposes than the following. If the purpose of use is changed, prior consent shall be obtained.
